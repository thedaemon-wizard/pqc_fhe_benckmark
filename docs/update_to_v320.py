...
def generate_v320_report():
    ...
    toc_items = [
        ...
        '10. API Reference (22 New v3.2.0 Endpoints)',
    ...
    # 10. API Reference
    # -----------------------------------------------------------------------
    add_heading(doc, '10. API Reference (New v3.2.0 Endpoints)', level=1)
    add_styled_table(doc,
    ...
    add_styled_table(doc,
        ...
        [
            ...
            ['TestSectorCircuitBenchmark', '12', 'ALL PASSED',
    ...
    add_body_text(doc, 'Total: 173 tests, 173 passed, 0 failed, 0 errors. Execution time: ~259 seconds (Qiskit AerSimulator + GPU).')
